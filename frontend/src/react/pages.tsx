...
function MusicSources(): ReactElement {
  return <details className="music-sources"><summary>Music sources &amp; advanced controls</summary><div className="music-source-grid">
    ...
    <section><button id="connect-apple-music" className="button secondary provider-button" type="button">Connect Apple Music</button><p id="apple-music-status" className="rehearsal-status">Apple Music playback uses the official player.</p><input id="apple-music-search" type="search" placeholder="Song name or artist" /><button id="search-apple-music" className="button secondary" type="button">Search</button><div id="apple-music-results" className="spotify-results" /><input id="apple-music-song-id" type="text" placeholder="Apple Music song ID" /><button id="play-apple-music" className="button secondary" type="button">Play Apple Music song</button></section>
